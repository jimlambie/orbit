...
describe('ApiConnector', function () {
  ...
  describe('connect', function () {
    it.skip('should create and return database when connecting', function (done) {
      var apiConnector = new ApiConnector()
    ...
    it.skip('should have readyState == 1 when connected', function (done) {
      var apiConnector = new ApiConnector()
  ...
  describe.skip('find', function () {
    it('should find a single document in the database', function (done) {
      var apiConnector = new ApiConnector()
      apiConnector.connect({ database: 'content', collection: 'users' }).then(() => {
        var users = [{ name: 'Wallace' }, { name: 'Ernest' }]
    ...
    it.skip('should return the number of records requested when using `limit`', function (done) {
      var apiConnector = new ApiConnector()
      apiConnector.connect({ database: 'content', collection: 'users' }).then(() => {
    ...
    it.skip('should sort records in ascending order by the query property when no sort is provided', function (done) {
      var apiConnector = new ApiConnector()
      apiConnector.connect({ database: 'content', collection: 'users' }).then(() => {
    ...
    it.skip('should sort records in ascending order by the specified property', function (done) {
      var apiConnector = new ApiConnector()
      apiConnector.connect({ database: 'content', collection: 'users' }).then(() => {
        var users = [{ name: 'Ernie' }, { name: 'Oscar' }, { name: 'BigBird' }]
    ...
    it.skip('should sort records in descending order by the specified property', function (done) {
      var apiConnector = new ApiConnector()
      apiConnector.connect({ database: 'content', collection: 'users' }).then(() => {
        var users = [{ name: 'Ernie' }, { name: 'Oscar' }, { name: 'BigBird' }]
